...
export function EditProductPage() {
  const {
    ...
    defaultValues: {
      ...
      value: (578650 / 100).toLocaleString('pt-BR', {
    ...
    <main>
      ...
      >
        <FileUploadInput
          ...
          previewUrl="https://plus.unsplash.com/premium_photo-1661963780999-6712fcb46eec?q=80&w=2102&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          {...register('image')}
        />
